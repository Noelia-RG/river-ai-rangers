...
1. Read and describe three river water-quality measurements: pH, nitrates, and phosphates
2. Use an AI assistant to help them interpret what those numbers mean for river life
3. Produce one piece of civic writing addressed to a real audience

---

## Teacher Background (read before teaching)

Your local river action group has provided real water-quality readings from your river. These come from volunteers who visit the river regularly and test the water. The three measurements students will work with are:
...
You do not need to be an expert. The AI assistant will help students interpret the data — your role is to guide their questions and push them to think critically about what the AI tells them.
...
Write or display the real readings from your river group on the board:

| Measurement | Our River Reading | Healthy Range |
|-------------|------------------|---------------|
| pH | ___ | 6.5 – 8.5 |
| Nitrates | ___ mg/L | Below 10 mg/L |
| Phosphates | ___ mg/L | Below 0.1 mg/L |
...
Hand out the pupil worksheet. Students work individually or in pairs to:
...
Do not let students use the AI yet. This first pass is their own thinking.
...
> *"Our river has a pH of [value]. Is that healthy for the fish and invertebrates living there? Please explain clearly."*

Read the AI's response aloud. Then ask students: *"Does that match what you wrote on your worksheet? Does anything surprise you?"*

Now let students (in pairs or as a class) ask their own questions using the AI prompt cards provided. Encourage them to:
...
**Key teaching point:** Remind students that the AI is a tool, not an expert. It can be wrong. Their job is to think about whether its answers make sense.

---

### 5. Action output (10 minutes)

Tell students: *"Now you know what the data says. Someone needs to hear about it."*
...
Students spend the remaining time beginning their chosen output. Completion can be homework or the next session.

**Minimum expectation:** Every student writes at least one sentence that includes a real number from the data. *"Our river's phosphate level is ___, which means ___."*

---

### 6. Close (5 minutes)

Ask three students to share one sentence from their output.
...
- **Formative:** Observe student responses during the AI investigation. Are they questioning the AI's answers?
...
- If possible, share one piece of student work (anonymised) with your local river group. It will matter to them.

---

*River AI Rangers is open-source and free. All materials at github.com/Noelia-RG/river-ai-rangers*
